                            ...
                            <div class="p-2">
                                <?php
                                    ...
                                    if(isset($_POST["btnsubmit"]))
                                    {
                                        ...
                                        // echo $id;
                                        $result = mysqli_query($conn,"select * from tbl_architect where architect_id= '$id' AND password='$oldpw'") or die (mysqli_error($conn));
                                        ...
                                        if($row==1)
                                        {
                                            ...
                                            $result = mysqli_query($conn,"update tbl_architect set password='$newpw' where architect_id='$id' ") or die (mysqli_error($conn));
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mt-3 d-grid">
                                        <a href="dashboard.php"  class="btn btn-danger waves-effect waves-light" type="submit">Cancel</a>
                                    </div>
