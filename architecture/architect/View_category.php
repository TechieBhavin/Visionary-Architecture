                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $count = "1";
                                            $result = mysqli_query($conn, "select * from tbl_category where type = 'architect'") or die(mysqli_error($conn));
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img height="100px" src="../admin/uploads/category/<?php echo $row["cat_icon"] ?>" alt=""></td>
                                                    <td><?php echo $row["type"] ?></td>
                                                    <!-- <td>
                                                        <a href="Updatecategory.php?updateid=<?php echo $row["cat_id"] ?>" type="submit" name="btnsubmit" class="btn btn-primary waves-effect waves-light">Edit</a>
                                                         
                                                        <button type="button" class="btn btn-danger waves-effect waves-light delete-btn" delete-id="<?php echo $row["cat_id"] ?>" delete-image="<?php echo $row["cat_icon"] ?>" data-bs-toggle="modal" data-bs-target="#myModal">Delete </button>
                                                    </td> -->

                                                    <!-- <td>
                                                        <div class="d-flex justify-content align-items-center">

                                                            <a class="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="Updatecategory.php?updateid=<?php echo $row["cat_id"] ?>">
                                                            ...
                                                            <a class="badge bg-danger " data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="#" data-bs-toggle="modal" data-bs-target="#myModal">
                                                                <svg xmlns="http://www.w3.org/2000/svg" class="delete-btn" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-toggle="modal" data-target="#exampleModal" name="btnsubmit" id="btnsubmit" delete-id="<?php echo $row["cat_id"] ?>">
