                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">View certificate</h4>

                                <div class="page-title-right">
                                    <a type="submit" href="add_certificate.php" class="btn btn-primary waves-effect waves-light">Add</a>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            echo "aid :".$aid;
                                            $result = mysqli_query($conn, "select * from tbl_certificate as c left join tbl_architect as a on a.architect_id=c.architect_id where a.architect_id='$aid'") or die(mysqli_error($conn));
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img height="100px" src="uploads/architect/<?php echo $row["cer_img"] ?>" alt=""></td>
                                                    
                                                    <td>
                                                        <a   type="submit" name="btnsubmit" class="btn btn-primary waves-effect waves-light">Edit</a>
                                                         
                                                        <button type="button" class="btn btn-danger waves-effect waves-light delete-btn" >Delete </button>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
