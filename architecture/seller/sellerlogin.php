                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        ...
                                        <p>Sign in to continue to Seller.</p>
                                    </div>
                                </div>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="p-2">
                                ...
                                if (isset($_POST["btnsubmit"])) {
                                    ...
                                    $result = mysqli_query($conn, "select * from tbl_seller where (email='$username' and password='$password') and (isverify='yes' and isblock='no')") or die(mysqli_error($conn));
