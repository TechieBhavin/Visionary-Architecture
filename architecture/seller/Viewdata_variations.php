                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_GET["viewid"])) {
                                                ...
                                                $result = mysqli_query($conn, "select *,v.isactive as visactive,v.img1 as vimg1,v.img2 as vimg2,v.img3 as vimg3,v.description as vdescription,v.price as vprice from tbl_variations as v left join tbl_product as p on p.pid=v.pid where var_id='$id'");
