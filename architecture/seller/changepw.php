                            ...
                            <div class="p-2">
                                <?php
                                    ...
                                    if(isset($_POST["btnsubmit"]))
                                    {
                                        ...
                                        $result = mysqli_query($conn,"select * from tbl_seller where seller_id= '$id' AND password='$oldpw'") or die (mysqli_error($conn));
                                        ...
                                        if($row==1)
                                        {
                                            ...
                                            $result = mysqli_query($conn,"update tbl_seller set password='$newpw' where  seller_id='$id' ") or die (mysqli_error($conn));
