                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $count = "1";
                                            $result = mysqli_query($conn, "select * from tbl_order as o left join tbl_user as u on u.user_id=o.user_id left join tbl_city as c on c.city_id=o.city_id where status = 'process'" ) or die(mysqli_error($conn));
