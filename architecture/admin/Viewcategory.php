                        ...
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <a type="submit" href="Addcategory.php" class="btn btn-primary waves-effect waves-light">Add</a>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img height="100px" src="uploads/category/<?php echo $row["cat_icon"] ?>" alt=""></td>
