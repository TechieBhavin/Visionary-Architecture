                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    if (isset($_POST["btnsubmit"])) {
                                        ...
                                        $sql = mysqli_query($conn, "select * from tbl_subcategory where subcat_name='$scname' and cat_id='$cid' ");
                                        ...
                                        if (mysqli_num_rows($sql) <= 0) {
                                            ...
                                            $result = mysqli_query($conn, " insert into tbl_subcategory (cat_id,subcat_name) values ('$cid','$scname') ") or die(mysqli_error($conn));
                                    ...
                                    <form method="POST" id="form">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" name="scname" id="scname">
                                            </div>
                                        </div>

                                        <div>
                                            <button type="submit" name="btnsubmit" class="btn btn-primary waves-effect waves-light">Add Sub Category</button>
