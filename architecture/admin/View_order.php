                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                        ...
                                        if (isset($_POST["btnispay"])) {
                                            ...
                                            $result = mysqli_query($conn, "update tbl_orderdata set is_pay='$data' where order_id='$id'");
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $count = "1";
                                            $result = mysqli_query($conn, "select * from tbl_orderdata") or die(mysqli_error($conn));
                                            ...
                                            ?>
                                                ...
                                                <td><?php echo $row["order_datetime"] ?></td> -->
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="Viewdata_order.php.?viewid=<?php echo $row["order_id"] ?>" type="submit" name="btnsubmit" class="btn btn-success waves-effect waves-light">View</a>
