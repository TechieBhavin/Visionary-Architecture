                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <!-- <td><img height="100px" src="../seller/uploads/variation/<?php echo $row["vimg1"] ?>" alt=""></td> -->
                                                    <!-- <th><?php echo $row["vimg2"] ?></th> -->
                                                    <!-- <td><img height="100px" src="../seller/uploads/variation/<?php echo $row["vimg2"] ?>" alt=""></td> -->
                                                    <!-- <th><?php echo $row["vimg3"] ?></th> -->
                                                    <!-- <td><img height="100px" src="../seller/uploads/variation/<?php echo $row["vimg3"] ?>" alt=""></td> -->
                                                    <th><?php echo $row["vdescription"] ?></th>
                                                    <!-- <th><?php echo $row["visactive"] ?></th> -->
                                                    ...
                                                    <td>
                                                    <a href="viewsdata_variations.php?viewid=<?php echo $row["var_id"] ?>" type="submit" name="btnsubmit" class="btn btn-success waves-effect waves-light">View</a>
                                                    </td>
