                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">View log</h4>
                            ...
                            <div class="card">
                                ...
                                <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
                                    ...
                                    if (isset($_POST["btndelete"])) {
                                        ...
                                        $result = mysqli_query($conn, "delete from tbl_log where log_id = '$id'");
                                        echo "<script>window.location='View_log.php'</script>";
                                    }
                                    ?>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                                $count = "1";
                                                $result = mysqli_query($conn,"select * from tbl_log") or die ( mysqli_error($conn));
                                            ...
                                            <tr>
                                                ...
                                                <button type="button" class="btn btn-danger waves-effect waves-light delete-btn" delete-id="<?php echo $row["log_id"] ?>" data-bs-toggle="modal" data-bs-target="#myModal">Delete</button>
                                                </td>
                                            </tr>   
                                                    <?php
                                                }
