                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                        ...
                                        <tbody>
                                            <?php
                                            $count = "1";
                                            $result = mysqli_query($conn, "select *,p.description as pdescription,p.title as ptitle,p.price as vprice,p.img1 as pimg1,p.img2 as pimg2,p.img3 as pimg3,p.video_url as purl,p.product_type as ptype from tbl_product as p left join tbl_subcategory as c on c.subcat_id=p.subcat_id left join tbl_seller as s on s.seller_id=p.seller_id left join tbl_brand as b on b.bid=p.bid") or die(mysqli_error($conn));
