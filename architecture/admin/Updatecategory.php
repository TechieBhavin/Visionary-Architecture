                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    if(isset($_POST["btnsubmit"]))
                                    {
                                        ...
                                        move_uploaded_file($_FILES["caticon"]["tmp_name"], "uploads/category/" . $filename3);
                                            $newimage=$filename3;
                                        }
                                        ...
                                        $result = mysqli_query($conn,"update tbl_category set cat_name='$name',cat_icon='$newimage',type='$Type'  where cat_id='$id'") or die(mysqli_errno($conn));
                                ...
                                <?php
                                    ...
                                    <?php
                                        ...
                                        if(isset($_GET["updateid"]))
                                        {
                                            ...
                                            $result = mysqli_query($conn,"select * from tbl_category where cat_id='$id'");
                                    ...
                                    <form id="frm" method="POST" enctype="multipart/form-data"> 
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" value="<?php echo $row["cat_name"] ?>" type="text" name="catname" id="catname">
                                            </div>
                                        </div>
                                        <div class="col-md-10">
                                                <input class="form-control" value="<?php echo $row["cat_icon"] ?>" type="hidden" name="oldtextimage" id="catname">  
                                            </div>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <img height="100px" width="100px" src="uploads/category/<?php echo $row["cat_icon"] ?>" />
                                            </div>
                                        ...
                                        <div class="col-xl-3 col-sm-6">
                                            <div class="mt-4">
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" value="architect" <?php if ($row["type"] == "architect") { ?> checked <?php } ?>  type="radio" name="Type" id="Type">
                                                    <label class="form-check-label" for="formRadios1">
                                                    architect
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" value="shop" <?php if ($row["type"] == "shop") { ?> checked <?php } ?> type="radio" name="Type" id="Type">
                                        ...
                                        <div>
                                            <button type="submit" name="btnsubmit" class="btn btn-primary waves-effect waves-light">Update Category</button>
