                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">View order item</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                                $count = "1";
                                                $result = mysqli_query($conn,"select * from tbl_order_item as o left join tbl_product as p on p.pid=o.pid") or die ( mysqli_error($conn));
