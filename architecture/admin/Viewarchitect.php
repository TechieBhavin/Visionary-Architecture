                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">View Architect</h4>

                                <!-- <div class="page-title-right">
                                    <a type="submit" href="Addarchitect.php" class="btn btn-primary waves-effect waves-light">Add</a>
                                </div> -->
                                <a href="Addarchitect.php" class="btn btn-primary position-relative d-flex align-items-center justify-content-between">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                        ...
                                        if (isset($_POST["btnverify"])) {
                                            ...
                                            $result = mysqli_query($conn, "update tbl_architect set isverify='$data' where architect_id='$id'");
                                        ...
                                        if (isset($_POST["btnblocked"])) {
                                            ...
                                            $result = mysqli_query($conn, "update tbl_architect set isblocked='$data' where architect_id='$id'");
                                        ...
                                        if (isset($_POST["btnapproved"])) {
                                            ...
                                            $result = mysqli_query($conn, "update tbl_architect set isapproved='$data' where architect_id='$id'");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                            <form method="post">
                                                                ...
                                                                <input type="hidden" name="dataid" value="<?php echo $row["architect_id"] ?>">
                                                            </form>
                                                        <?php
                                                        } else {
                                                        ?>
                                                 ...
                                                 <th><?php echo $row["about_us"] ?></th> -->
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="Viewdata_architect.php?viewid=<?php echo $row["architect_id"] ?>" type="submit" name="btnsubmit" class="btn btn-success waves-effect waves-light">View</a>
                                                        <button type="button" class="btn btn-danger waves-effect waves-light delete-btn" delete-id="<?php echo $row["architect_id"] ?>" data-bs-toggle="modal" data-bs-target="#myModal">Delete</button>
                                                    </td>
