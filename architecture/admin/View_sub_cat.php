                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">View Sub Category</h4>

                                <div class="page-title-right">
                                <a type="submit" href="Add_sub_cat.php"  class="btn btn-primary waves-effect waves-light">Add</a>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                        ...
                                        <?php 
                                                $count = "1";
                                                $result = mysqli_query($conn,"select * from tbl_subcategory as s left join tbl_category as c on c.cat_id=s.cat_id") or die ( mysqli_error($conn));
                                            ...
                                            <tr>
                                                 ...
                                                 <td>
                                                <a href="Update_sub_cat.php?updateid=<?php echo $row["subcat_id"] ?> " type="submit" name="btnsubmit" class="btn btn-primary waves-effect waves-light">Edit</a>
                                                 
                                                <button type="button" class="btn btn-danger waves-effect waves-light delete-btn" delete-id="<?php echo $row["subcat_id"] ?>" data-bs-toggle="modal" data-bs-target="#myModal">Delete</button>
                                                </td>
                                            </tr>
                                            <?php
                                                }
